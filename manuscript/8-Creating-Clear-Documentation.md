...
o) Unusual data formats or steps are described 
o) Describes the reasoning behind decisions

{choose-answers: 4} 
? What is NOT true about a README file?

C) They don't help readers navigate to information they need 
C) They don't help others understand the goals of the project 
m) They allow people to quickly get a sense of what is happening with the project 
m) They enable people to find files or other aspects related to the project 
o) They describe necessary tools that are used in the project 
o) They explain the inputs and outputs
