...
In this section we will cover the following learning obejectives: 

```{r, fig.alt="Learning Objectives: Discuss why the NIH decided to enact a new data management and sharing policy, explain what a data management and sharing plan is", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/10nOR2t1-F0E01fItN_l8uYRWslH2PmebPvhQzCBeCPM/edit?slide=id.g3896feb580f_16_24#slide=id.g3896feb580f_16_24")
```
