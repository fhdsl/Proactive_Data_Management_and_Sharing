...
```{r, echo=FALSE, fig.alt='I can determine if a DMS plan is required using the table by loooking for the activity code and then the column about data sharing plan requirement. ', out.width = '80%', fig.align = 'center'}
