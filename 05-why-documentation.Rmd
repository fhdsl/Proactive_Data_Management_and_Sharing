...
```{r, fig.align='center', echo = FALSE, fig.alt= "Learning Objectives: 1.Explain why documentation is so useful for reserach, 2. Describe how documentation of your analyses can help both you and other researchers in the future, ultimately saving time", out.width="100%"}
