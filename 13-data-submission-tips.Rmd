...
```{r, fig.alt = "Learning objectives: Explain how REDCap can be used to help keep data secure, compliant with HIPAA  requirements, and facilitate collaboration; Identify best practices for keeping data safe using REDCap", out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/10nOR2t1-F0E01fItN_l8uYRWslH2PmebPvhQzCBeCPM/edit?slide=id.g3896feb580f_16_10#slide=id.g3896feb580f_16_10")
```
