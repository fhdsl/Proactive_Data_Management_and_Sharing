...
```{r, fig.alt = "Learning objectives: explain what metadata is, describe how to create metadata, identify best practices for creating good metadata to support your research", out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/10nOR2t1-F0E01fItN_l8uYRWslH2PmebPvhQzCBeCPM/edit?slide=id.g3896feb580f_34_6#slide=id.g3896feb580f_34_6")
```
