...
```{r topics_covered, echo=FALSE, fig.alt='Topics Discussed in the proactive data management and sharing course: Organizing and documenting your project. How computing hardware and software work. Keeping good records and metadata. Identifying computing resources that meet your needs. Create data sharing plans consistent with N I H requirements. Sharing and submitting data properlyE', out.width = '100%', fig.align = 'center'}
