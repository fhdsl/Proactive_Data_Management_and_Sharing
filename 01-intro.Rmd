...
```{r, echo=FALSE, fig.alt='Proactive Data Management and Sharing, written by Carrie Wright and Candace Savonen', out.width = '100%', fig.align = 'center'}
...
- Desribe what data sharing is and why is it important
...
- Explain what elements are in a data management and sharing plan consistent with NIH requirements
